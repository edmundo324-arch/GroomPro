...
const modules=["Calendar","Customers","Pets","Tickets","Whiteboard","Messaging","Inventory","Reports","Settings"] as const;
...
export default function Home(){
 ...
 const allowed=modules.filter(m=>m==="Settings"||enabled.includes(m.toUpperCase().replace(" ","_")));
